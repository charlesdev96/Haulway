...
class CartRouter {
    ...
    initializeRoute() {
        ...
        //add item to cart
        this.router.post("/add-item/:postId/:productId", middleware_1.authorizeUser, (0, middleware_1.validateInputs)(schema_1.addItemToCartSchema), this.cartController.addProductToCart.bind(this.cartController));
        //update cart item
