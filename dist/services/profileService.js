...
exports.getUserProfile = exports.getInfluencerProfile = exports.getVendorProfile = void 0;
...
const getInfluencerProfile = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const contracts = yield (0, services_1.chnageVendorContractStatus)(userId);
    // Update the status of the found contracts to 'completed'
    for (const contract of contracts) {
        contract.status = "completed";
    ...
    return yield model_1.UserModel.findById(userId)
        .select("_id profilePic fullName userName role numOfFollowers numOfFollowings numOfPosts posts savedPosts influencerPro requests contracts")
        .populate({
        path: "posts",
        select: "_id content caption postedBy thumbNail views numOfLikes numOfComments comments options tagPeople products",
        populate: [
...
exports.getInfluencerProfile = getInfluencerProfile;
